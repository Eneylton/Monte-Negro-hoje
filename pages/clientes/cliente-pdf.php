...
$listar = Cliente::getListCleintes();
...
foreach ($listar as $item) {
    ...
    $res .= '
                <tr>
                    ...
                    <td style="text-align:left;text-transform: uppercase;">'  . $item->servicos . '</td>
                    <td style="text-align:left;text-transform: uppercase;">'  . $item->setores . '</td>
                    <td style="text-align:left; text-transform:uppercase">' . $item->entregador . '</td>
