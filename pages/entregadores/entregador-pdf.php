...
$listar = Entregador::getList('e.id as id,e.cnh as cnh, e.renavam as renavam,e.nome as entregador,e.cpf as cpf,e.telefone as telefone,e.email as email,e.banco as banco,e.veiculos_id as veiculos_id,
e.agencia as agencia,e.conta as conta,e.pix as pix,re.nome as regiao,r.nome as rota,v.nome as veiculo','entregadores AS e
INNER JOIN
rotas AS r ON (e.rotas_id = r.id)
INNER JOIN
regioes AS re ON (e.regioes_id = re.id)
INNER JOIN
veiculos AS v ON (e.veiculos_id = v.id)',null,null);
...
foreach ($listar as $item) {
    ...
    $res .= '
                <tr>
                    ...
                    <td style="text-align:left;text-transform: capitalize; width:100px">' . $item->veiculo . '</td>
    ...
    <table>
        <tbody>
            ...
            <tr style="background-color: #000; color:#fff">
                ...
                <td style="text-align: left;text-transform:uppercase">Rota</td>
