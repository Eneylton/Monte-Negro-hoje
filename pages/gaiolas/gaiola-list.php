...
define('TITLE', 'Lista de Gaiolas');
define('BRAND', 'Gaiolas');
...
$pagination = new Pagination($qtd, $_GET['pagina'] ?? 1, 501);

$listar = Setor::getList('*', 'gaiola', $where, 'nome ASC', $pagination->getLimit());
