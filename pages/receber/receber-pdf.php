...
$listar = Receber::getList('r.id AS id,
                            ...
                            'receber AS r
                            INNER JOIN
                            clientes AS cli ON (r.clientes_id = cli.id)',$consulta ,'r.data ASC', null);

foreach ($listar as $item) {

    $total = ($item->recebido - $item->qtd);
    $total_disp += $total;
    $total_qtd += $item->qtd;
    ...
    $res .= '   <tr>
                        ...
                        <td >' . $item->recebido. '</td>
                        <td style="text-align:left;text-transform: uppercase; width:250px">' . $item->qtd. ' - '. $msn. '</td>
        ...
        <tbody>
            <tr style="background-color: #fff; color:#000">
                ...
                <td style="text-align: left; width:260px; border:1px solid #fff; ">
                    <span style="margin-left:110px; margin-top: -50px; font-size:small">Monte Negro express </span><br>
    ...
    <table>
        <tbody>
            <tr style="background-color:#3ae210; color:#fff">
                <td style="text-align: center; text-transform:uppercase" colspan="9">Lista de itens recebidos</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                <span style="color:ff0000;"><?php echo $total_qtd ." DISPONIVÉIS" ?></span>
                </td>
                <td>
